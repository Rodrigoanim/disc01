# Arquivo: form_model_recalc_06.py
# Data: 14/12/2025
# Versão multi-assessment: Inventário Vocacional e Profissional (Assessment 06)
# Rotina de recálculo de fórmulas para forms_tab_06
...
def verificar_dados_usuario_06(cursor, user_id):
    """Verifica/copia dados do template (user_id=0) para novo usuário na forms_tab_06"""
    try:
        cursor.execute("SELECT COUNT(*) FROM forms_tab_06 WHERE user_id = ?", (user_id,))
...
def calculate_formula_06(cursor, name, user_id):
    """Calcula o valor de uma fórmula na forms_tab_06"""
    try:
        cursor.execute("""
            SELECT math_element 
            FROM forms_tab_06 
...
def atualizar_formulas_06(cursor, user_id):
    ...
    try:
        ...
        for formula in formulas:
            ...
            result = calculate_formula_06(cursor, name_element, user_id)
